...
const items: NavItem[] = [
  ...
  { title: "Users Report Results", url: "/owner-console/users-report-results", icon: Mail, external: true, keywords: ["report", "my report", "report only", "blurred", "locked report", "users report results"] },
