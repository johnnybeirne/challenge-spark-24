...
export const PREMIUM_LOCK_MESSAGE =
  "This module is part of the VIP LeadTree growth system. Unlock VIP Training to access Advanced Challenge Systems, Scaling With LeadTree, AI implementation systems, and advanced referral mechanics.";
