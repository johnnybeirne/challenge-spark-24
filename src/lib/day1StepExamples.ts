...
export const DEFAULT_STEP5_ROWS: Day1StepExampleRow[] = [
  ...
  { step_id: "step-5", audience_type: "b2b", audience_role: "saas", label: "SaaS teams", match_keywords: ["saas", "founder", "startup"], sort_order: 40, examples: ["Can't convert free trials to paid", "Churn is killing growth", "Acquisition cost is too high"] },
