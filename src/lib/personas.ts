...
export const PERSONAS: PersonaDefinition[] = [
  ...
  },
  {
    ...
    memoryOverrides: {
      ...
      challengeType: "transformation",
      topic: "next chapter",
      desiredOutcome: "clarity on what comes next",
    ...
    aiOutputOverrides: {
      ...
      day1Setup: JSON.stringify({
        audience: "Women in their 40s and 50s navigating a major life change",
        problem: "They know something needs to change but they do not know where to start",
        outcome: "Clarity on their next chapter and one concrete move to make",
        superpower: "Helping women find direction after major life transitions",
        expertType: "Coach",
        challengeType: "transformation",
      }),
    },
