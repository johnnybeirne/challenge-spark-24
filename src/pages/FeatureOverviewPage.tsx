...
const FeatureOverviewPage = ({ mode }: FeatureOverviewPageProps) => {
  ...
  return (
    <>
      <SEO title="Platform Features" description="Explore the full LeadTree platform — from assessment funnels and AI challenges to referral loops and partner networks." canonical="/app/features" />
