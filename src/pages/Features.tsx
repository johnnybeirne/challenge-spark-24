...
const CURATED: Feature[] = [
  ...
  { icon: <Brain className="h-5 w-5 text-primary" />, title: "Johnny B AI Chat", description: "Built-in Johnny B AI assistant to help you through each challenge step.", category: "AI", addedAt: "2026-03-30" },
