...
const ASSESSMENT_CARDS: Card[] = [
  { title: "Challenge Assessment", route: "/assessment", description: "Same LeadTree assessment → routes users into the 3-Day Challenge after results.", badge: "challenge" },
  ...
  return (
    ...
    <main className="min-h-screen bg-background text-foreground">
      <div className="mx-auto w-full max-w-4xl px-5 py-12 sm:px-6 lg:px-8">
        <h1 className="text-3xl font-black sm:text-4xl">LeadTree link directory</h1>
