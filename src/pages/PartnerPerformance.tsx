...
const PartnerPerformance = () => {
  ...
  const handleShare = () => {
    shareOrCopy({ text: "Join the challenge — build and launch in 3 days", url: partnerLink });
  };
      ...
      <div className="app-page-container py-8 pb-24">
        ...
        <div className="mb-6">
          ...
          <p className="text-sm text-muted-foreground">
            See how your asset and profile are performing inside the challenge network.
          </p>
