...
const OUTCOMES = [
  ...
  "Lifetime updates as LeadTree evolves",
];
...
const FAQS = [
  {
    ...
    a: "Both. You get the full LeadTree Premium course (5 modules, lifetime access) plus the AI-powered LeadTree platform — diagnostic, 3-day implementation challenge, referral engine, and partner system.",
  },
  {
      ...
      <main className="mx-auto w-full max-w-5xl px-4 py-10 lg:py-16">
        ...
        <section className="mt-14 rounded-3xl border border-border bg-card p-8 sm:p-10">
          ...
          <p className="mt-4 text-xl font-bold leading-relaxed text-foreground sm:text-2xl">
            "LeadTree finally connected the dots. Three days in, I had a working referral loop that
          ...
          {!isOpen && (
            <div className="mt-8 flex flex-col items-start gap-3 sm:flex-row sm:items-center">
              <Button
                ...
                className="h-14 gap-2 px-8 text-base font-black uppercase tracking-wide"
              >
                <Rocket className="h-5 w-5" /> Unlock LeadTree Premium
                <ArrowRight className="ml-1 h-4 w-4" />
              </Button>
        ...
        <section className="mt-14 flex flex-col items-center gap-4 rounded-3xl border border-primary/30 bg-gradient-to-br from-primary/10 via-background to-background p-10 text-center">
          ...
          <p className="max-w-xl text-sm text-muted-foreground">
            Lifetime access to the full LeadTree system. One payment. Refundable for 14 days.
          </p>
          <Button
            onClick={handleBuy}
