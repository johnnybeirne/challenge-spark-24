...
const STAGES: Stage[] = [
  {
    ...
    index: 1,
    title: "Discover",
    subtitle: "Landing → 9-question diagnostic at /assessment",
    type: "input",
    badge: "Awareness",
    icon: ClipboardList,
    fields: [
      { label: "Entry route", value: "/  →  /assessment" },
      { label: "Attribution", value: "Captures ?ref, /invite/:code, /p/:partnerCode" },
      { label: "Time to complete", value: "~3 minutes" },
    ],
    actions: ["Answer 9 lead-flow questions", "AttributionCapture stores referrer", "Save partial progress"],
    metric: { label: "Assessment time", value: "3 min" },
  },
  {
    id: "diagnose",
    index: 2,
    title: "Diagnose",
    subtitle: "Score → tiered AI coach reply on /results",
    type: "processing",
    badge: "AI scoring",
    icon: Sparkles,
    fields: [
      { label: "Output", value: "Score · diagnosis · recommended path" },
      { label: "Source", value: "Diagnostic responses editor (admin-tunable)" },
      { label: "Routing", value: "Challenge · Blueprint · Premium" },
    ],
    actions: ["Compute tier (low / med / high)", "Render AI coach reply", "Suggest next step CTA"],
    metric: { label: "Tier branches", value: "3" },
    branches: [
      { label: "Low → Free Blueprint", to: "blueprint" },
      { label: "Med → 3-Day Challenge", to: "signup" },
      { label: "High → Premium Course", to: "premium" },
    ],
  },
  {
    id: "signup",
    index: 3,
    title: "Sign Up",
    subtitle: "Email or Google account at /challenge/join",
    type: "input",
    badge: "Activation",
    icon: UserPlus,
    fields: [
      { label: "Methods", value: "Email + password · Google OAuth" },
      { label: "Routed to", value: "/challenger-dashboard" },
      { label: "Credits referrer", value: "Yes — attribution attached on signup" },
    ],
    actions: ["Create account", "Persist assessment to dashboard", "Fire signup analytics event"],
    metric: { label: "Steps to start", value: "1" },
  },
  {
    id: "day1",
    index: 4,
    title: "Day 1 — Foundation",
    subtitle: "Niche, audience, promise, challenge title",
    type: "processing",
    badge: "In progress",
    icon: Target,
    fields: [
      { label: "Inputs", value: "Niche · Audience · Promise · Title" },
      { label: "Helpers", value: "AI copilot chat · dictation on every field" },
      { label: "Saves to", value: "Your Dashboard (read-only record)" },
    ],
    actions: ["Guided AI builder", "Toast: 'Your dashboard is updated'", "Unlocks Day 2"],
    metric: { label: "Time budget", value: "~60 min" },
  },
  {
    id: "day2",
    index: 5,
    title: "Day 2 — Lead Magnet Quiz",
    subtitle: "Build a quiz-style lead magnet",
    type: "processing",
    badge: "In progress",
    icon: Magnet,
    fields: [
      { label: "Inputs", value: "Quiz questions · outcomes · CTA copy" },
      { label: "AI outputs", value: "Generated quiz scaffolding" },
      { label: "Unlocks", value: "Invite nudge + Day 3" },
    ],
    actions: ["Dictation-friendly inputs", "Generate quiz with copilot", "Save to dashboard"],
    metric: { label: "Asset shipped", value: "1 quiz" },
  },
  {
    id: "day3",
    index: 6,
    title: "Day 3 — Launch",
    subtitle: "Submit live URL to mark the challenge complete",
    type: "approval",
    badge: "Approval gate",
    icon: Rocket,
    fields: [
      { label: "Required", value: "Live URL submission" },
      { label: "Triggers", value: "Challenge marked complete · unlocks engine fires" },
      { label: "Next", value: "Builder Circle progress + referral push" },
    ],
    actions: ["Validate URL", "Mark challenge complete", "Notify dashboard + bell"],
    metric: { label: "Outcome", value: "Shipped" },
  },
  {
    id: "earn",
    index: 7,
    title: "Earn & Refer",
    subtitle: "Unified /earn page — link, stats, unlocks, rewards",
    type: "branch",
    badge: "Growth loop",
    icon: Gift,
    fields: [
      { label: "Share", value: "Copy · Email · WhatsApp" },
      { label: "Tracks", value: "Direct + indirect referral counts" },
      { label: "Unlocks engine", value: "Perks at each referral milestone" },
    ],
    actions: ["Share personal link", "Track milestones on /unlocks", "Redeem credits on /redeem"],
    metric: { label: "Required for Circle", value: "3 direct" },
  },
  {
    id: "community",
    index: 8,
    title: "Builder Circle",
    subtitle: "/community — unlocked after launch + 3 direct referrals",
    type: "completion",
    badge: "Unlocked",
    icon: Users,
    fields: [
      { label: "Gate", value: "Day 3 done · URL submitted · 3 direct referrals" },
      { label: "Access", value: "Most engaged peers + leaderboard" },
      { label: "Source of truth", value: "src/lib/scoring.ts" },
    ],
    actions: ["Enter community", "Climb leaderboard", "Showcase shipped build"],
    metric: { label: "Status", value: "Active" },
  },
  {
    id: "beyond",
    index: 9,
    title: "Beyond the Challenge",
    subtitle: "Mentor · Prompt Library · Resources · Premium",
    type: "completion",
    badge: "Retention",
    icon: GraduationCap,
    fields: [
      { label: "Tools", value: "/mentor · /prompt-library · /resources" },
      { label: "Upgrade path", value: "/premium — Stripe embedded checkout" },
      { label: "Partner path", value: "/promoter + /partner/performance" },
    ],
    actions: ["Use post-challenge tools", "Upgrade to premium course", "Apply to become a partner"],
    metric: { label: "Lifetime value", value: "↑" },
  },
];
