...
const YourDashboard = () => {
  ...
  useEffect(() => {
    trackEvent("your_dashboard_viewed");
  }, []);

  // Day 1 — foundation + assessment + AI outputs
  const day1 = useMemo(() => {
    ...
    <main className="app-page-container min-h-screen py-5 pb-28 lg:py-8 lg:pb-8">
      <section className="mx-auto max-w-4xl space-y-5 sm:space-y-6">
        ...
        <section className="rounded-2xl border border-border bg-card p-5 shadow-sm sm:p-6">
          ...
          <h2 className="mt-1.5 text-lg font-bold text-foreground">Your 72-hour window</h2>
