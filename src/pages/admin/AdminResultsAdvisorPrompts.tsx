...
import { Loader2, Plus, Trash2, Sparkles, Mail } from "lucide-react";
        ...
        <div className="flex items-center justify-between gap-4">
          <div>
            <CardTitle className="text-lg flex items-center gap-2">
              <Mail className="h-5 w-5 text-primary" /> Report opt-in card
            </CardTitle>
            <CardDescription>
              The "get your report by email" card shown under the main button on the Results page.
            </CardDescription>
          </div>
