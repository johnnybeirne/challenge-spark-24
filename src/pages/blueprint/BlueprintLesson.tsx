...
const MODULES: Record<ModuleSlug, ModuleContent> = {
  ...
  "5": {
    ...
    intro:
      "Scaling with LeadTree is about compounding — partners, referrals, and offer ascension stacked on a trust-based foundation. You'll design the systems that turn one challenge into a repeatable growth engine.",
    takeaways: [
